...
```
Replace :id with the ID of your user, which can be found in the URL path when you are logged in. Under the body tab, create a parameter named `file` of type `file` and select a file to upload. Click `send` to upload the file.
